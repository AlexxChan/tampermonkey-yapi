...
/** 请求路径参数类型 */
export enum RequestParamTypeEnum {
  /** 字符串 */
  string = 'string',
  /** 数字 */
  number = 'number',
...
/** 请求查询参数类型 */
export enum RequestQueryTypeEnum {
  /** 字符串 */
  string = 'string',
  /** 数字 */
  number = 'number',
...
/** 请求表单条目类型 */
export enum RequestFormItemTypeEnum {
  /** 纯文本 */
  text = 'text',
  /** 文件 */
  file = 'file',
...
export interface Interface {
  ...
  req_query: Array<{
    ...
    required: RequiredEnum
    /** 类型（YApi-X） */
    type?: RequestQueryTypeEnum
  }>
  /** 仅 POST：请求内容类型。为 text, file, raw 时不必特殊处理。 */
  req_body_type: RequestBodyTypeEnum
  ...
  /** 返回数据类型 */
  res_body_type: ResponseBodyTypeEnum
...
export interface SharedConfig {
   ...
   */
  queryStringArrayFormat?: QueryStringArrayFormatEnum
